...
Info
    Defines class DefaultB64DataValidator for strict B64 data validation.
'''
...
class DefaultB64DataValidator(IDataValidator):
    '''
        Defines class DefaultB64DataValidator with attribute(s) and method(s).
        Creates data validator for B64.
        ...
        It defines:
            ...
            :methods:
                | __init__ - Initializes DefaultB64DataValidator constructor.
                | is_valid - Validates if data is in B64 format.
    '''

    def __init__(self, char_validator: Optional[ICharacterValidator] = None) -> None:
        '''
            Initializes DefaultB64DataValidator constructor.

            :param char_validator: Character validator instance | None
            :type char_validator: <Optional[ICharacterValidator]>
            :exceptions: None
        '''
        self.__char_validator: ICharacterValidator = char_validator or DefaultB64CharacterValidator()

    def is_valid(self, data: Optional[str]) -> bool:
        '''
            Validating if data is in B64 format.
