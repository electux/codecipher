...
Info
    Defines class DefaultB64ValidationEngine for managing multiple data validators.
'''
...
class DefaultB64ValidationEngine(IValidationEngine):
    '''
        Defines class DefaultB64ValidationEngine with attribute(s) and method(s).
        Creates validation engine class for B64.
        ...
        It defines:
            ...
            :methods:
                | __init__ - Initializes DefaultB64ValidationEngine constructor.
    ...
    def __init__(self, validators: Optional[List[IDataValidator]] = None) -> None:
        '''
            Initializes DefaultB64ValidationEngine constructor.

            :param validators: Initial list of validators | None
            :type validators: <Optional[List[IDataValidator]]>
            :exceptions: None
        '''
        self.__validators: List[IDataValidator] = validators or [DefaultB64DataValidator()]
