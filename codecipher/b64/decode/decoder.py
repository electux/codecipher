...
Info
    Creates class decoder with cipher B64 logic.
'''
...
from codecipher.b64.decode.decode_algorithm import DecodeAlgorithm
...
class Decoder(IDecoder):
    '''
        ...
        It defines:
            ...
            :methods:
                ...
                | decode - Decode data by cipher B64 logic.
    '''
    ...
    def decode(self, data: Optional[str] = None) -> bool:
        '''
            Decode data by cipher B64 logic.
