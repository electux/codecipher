...
from codecipher.b64.encode.encoder import Encoder
from codecipher.b64.decode.decoder import Decoder
...
class B64(ICipherEngine):
    '''
        ...
        It defines:
            ...
            :attributes:
                | __config - Configuration for cipher B64.
                | __validation_engine - Engine for data validation.
                | __encoder - Encoder for cipher B64.
                | __decoder - Decoder for cipher B64.
            :methods:
    ...
    def __init__(
        ...
        '''
            ...
            :param config: Configuration for cipher B64 | None
        ...
        self.__config: IConfig = config or B64Config()
