...
Info
    Creates class encoder with cipher ATBS logic.
'''
...
from codecipher.atbs.encode.encode_algorithm import EncodeAlgorithm
...
class Encoder(IEncoder):
    '''
        ...
        It defines:
            ...
            :methods:
                ...
                | encode - Encode data by cipher ATBS logic.
    '''
    ...
    def encode(self, data: Optional[str] = None) -> bool:
        '''
            Encode data by cipher ATBS logic.
