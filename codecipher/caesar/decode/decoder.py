...
Info
    Creates class decoder with cipher CAESAR logic.
'''
...
from codecipher.caesar.decode.decode_algorithm import DecodeAlgorithm
...
class Decoder(IDecoder):
    '''
        ...
        It defines:
            ...
            :methods:
                ...
                | decode - Decode data by cipher CAESAR logic.
    '''
    ...
    def decode(self, data: Optional[str] = None) -> bool:
        '''
            Decode data by cipher CAESAR logic.
