...
Info
    Defines class DefaultCaesarValidationEngine for managing multiple data validators.
'''
...
class DefaultCaesarValidationEngine(IValidationEngine):
    '''
        Defines class DefaultCaesarValidationEngine with attribute(s) and method(s).
        Creates validation engine class for CAESAR.
        ...
        It defines:
            ...
            :methods:
                | __init__ - Initializes DefaultCaesarValidationEngine constructor.
    ...
    def __init__(self, validators: Optional[List[IDataValidator]] = None) -> None:
        '''
            Initializes DefaultCaesarValidationEngine.

            :param validators: Initial list of validators | None
            :type validators: <Optional[List[IDataValidator]]>
            :exceptions: None
        '''
        self.__validators: List[IDataValidator] = validators or [DefaultCaesarDataValidator()]
