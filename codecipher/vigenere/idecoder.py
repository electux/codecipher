...
Info
    Defines interface IDecoder for VigenereDecoder class.
'''
...
class IDecoder(ABC):
    '''
        Defines interface IDecoder with methods.
        ...
        It defines:
            ...
            :methods:
                ...
                | decode - Decoding data from algorithm data format.
    '''
    ...
    def decode(self, data: Optional[str], key: Optional[str]) -> bool:
        '''
            Decoding data from algorithm data format.
