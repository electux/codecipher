...
Info
    Creates class encoder with cipher VIGENERE logic.
'''
...
from codecipher.vigenere.encode.encode_algorithm import EncodeAlgorithm
...
class Encoder(IEncoder):
    '''
        ...
        It defines:
            ...
            :methods:
                ...
                | encode - Encode data by cipher VIGENERE logic.
    '''
    ...
    def encode(self, data: Optional[str] = None) -> bool:
        '''
            Encode data by cipher VIGENERE logic.
