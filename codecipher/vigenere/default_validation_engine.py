...
Info
    Defines class DefaultVigenereValidationEngine for managing multiple data validators.
'''
...
class DefaultVigenereValidationEngine(IValidationEngine):
    '''
        Defines class DefaultVigenereValidationEngine with attribute(s) and method(s).
        Creates validation engine class for VIGENERE.
        ...
        It defines:
            ...
            :methods:
                | __init__ - Initializes DefaultVigenereValidationEngine constructor.
    ...
    def __init__(self, validators: Optional[List[IDataValidator]] = None) -> None:
        '''
            Initializes DefaultVigenereValidationEngine.

            :param validators: Initial list of validators | None
            :type validators: <Optional[List[IDataValidator]]>
            :exceptions: None
        '''
        self.__validators: List[IDataValidator] = validators or [DefaultVigenereDataValidator()]
