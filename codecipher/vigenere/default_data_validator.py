...
Info
    Defines class DefaultVigenereDataValidator for strict VIGENERE data validation.
'''
...
class DefaultVigenereDataValidator(IDataValidator):
    '''
        Defines class DefaultVigenereDataValidator with attribute(s) and method(s).
        Creates data validator for VIGENERE.
        ...
        It defines:
            ...
            :methods:
                | __init__ - Initializes DefaultVigenereDataValidator constructor.
                | is_valid - Validates if data is in VIGENERE format.
    '''

    def __init__(self, char_validator: Optional[ICharacterValidator] = None) -> None:
        '''
            Initializes DefaultVigenereDataValidator constructor.

            :param char_validator: Character validator instance | None
            :type char_validator: <Optional[ICharacterValidator]>
            :exceptions: None
        '''
        self.__char_validator: ICharacterValidator = char_validator or DefaultVigenereCharacterValidator()

    def is_valid(self, data: Optional[str]) -> bool:
        '''
            Validating if data is in VIGENERE format.
