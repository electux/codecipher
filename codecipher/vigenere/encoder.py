...
Info
    Defines class VigenereEncoder with attribute(s) and method(s).
...
class VigenereEncoder(IEncoder):
    ...
    @encode_data.setter
    def encode_data(self, data: Optional[str]) -> None:
        '''
            Property method for setting encode data.

            :param data: Encode data | None
    ...
    def _split_data_encode(self, data: Optional[str], key: Optional[str]) -> List[str]:
        '''
