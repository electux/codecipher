...
Info
    Defines class DefaultVernamValidationEngine for managing multiple data validators.
'''
...
class DefaultVernamValidationEngine(IValidationEngine):
    '''
        Defines class DefaultVernamValidationEngine with attribute(s) and method(s).
        Creates validation engine class for VERNAM.
        ...
        It defines:
            ...
            :methods:
                | __init__ - Initializes DefaultVernamValidationEngine constructor.
    ...
    def __init__(self, validators: Optional[List[IDataValidator]] = None) -> None:
        '''
            Initializes DefaultVernamValidationEngine.

            :param validators: Initial list of validators | None
            :type validators: <Optional[List[IDataValidator]]>
            :exceptions: None
        '''
        self.__validators: List[IDataValidator] = validators or [DefaultVernamDataValidator()]
