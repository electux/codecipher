...
Info
    Defines class DefaultVernamDataValidator for strict VERNAM data validation.
'''
...
class DefaultVernamDataValidator(IDataValidator):
    '''
        Defines class DefaultVernamDataValidator with attribute(s) and method(s).
        Creates data validator for VERNAM.
        ...
        It defines:
            ...
            :methods:
                | __init__ - Initializes DefaultVernamDataValidator constructor.
                | is_valid - Validates if data is in VERNAM format.
    '''

    def __init__(self, char_validator: Optional[ICharacterValidator] = None) -> None:
        '''
            Initializes DefaultVernamDataValidator constructor.

            :param char_validator: Character validator instance | None
            :type char_validator: <Optional[ICharacterValidator]>
            :exceptions: None
        '''
        self.__char_validator: ICharacterValidator = char_validator or DefaultVernamCharacterValidator()

    def is_valid(self, data: Optional[str]) -> bool:
        '''
            Validating if data is in VERNAM format.
