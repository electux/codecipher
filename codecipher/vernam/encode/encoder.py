...
Info
    Creates class encoder with cipher VERNAM logic.
'''
...
from codecipher.vernam.encode.encode_algorithm import EncodeAlgorithm
...
class Encoder(IEncoder):
    '''
        ...
        It defines:
            ...
            :attributes:
                | _config - Configuration parameters for cipher VERNAM logic.
                | _strategy - Strategy for cipher VERNAM logic.
                | _encoded_data - Container for encoded data.
            :methods:
                | encoded_data - Property method for getting encoded data.
                | encode - Encode data by cipher VERNAM logic.
    '''

    _config: IConfig = field(default_factory=VernamConfig)
    ...
    def encode(self, data: Optional[str] = None) -> bool:
        '''
            Encode data by cipher VERNAM logic.
        ...
        # Execute cipher VERNAM logic with configuration parameters
