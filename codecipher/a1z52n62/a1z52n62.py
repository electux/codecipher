...
class A1z52N62(IA1z52N62):
    '''
        ...
        It defines:
            ...
            :attributes:
                ...
                | __char_validator - Validator for characters.
                | __data_validator - Validator for data.
    ...
    def __init__(
        ...
        data_validator: Optional[IDataValidator] = None,
        ...
        '''
            ...
            :param char_validator: Validator for characters | None
            :type char_validator: <Optional[ICharacterValidator]>
            :param data_validator: Validator for data | None
            :type data_validator: <Optional[IDataValidator]>
            ...
            :exceptions: None
        '''
        # Dependecy injection for config, encode, decode or use default
        self.__config = config or A1z52N62Config()
        self.__char_validator: ICharacterValidator = char_validator or CharacterValidator()
        self.__data_validator: IDataValidator = data_validator or DataValidator(self.__char_validator)
    ...
    def encode(self, data: Optional[str]) -> bool:
        '''
            ...
            :exceptions: None
        '''
        if not bool(data) or not self.__data_validator.is_valid(data):
            return False
    ...
    def decode(self, data: Optional[str]) -> bool:
        ...
        return self.__data_validator.is_valid(self.decode_data)
